...
APP_TITLE = "India Macro + Policy + Sector Rotation + 26M ATH Professional Engine"
NIFTY500_URLS = [
...
if not res.empty:
    ...
    with tabs[2]:
        ...
        st.caption("6M RS vs NIFTY > 0 means the median stock in that industry has outperformed the NIFTY benchmark over the same period.")
        st.dataframe(
            sector_df,
            use_container_width=True,
            hide_index=True,
